...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/rk9zKvRLQ30l/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/dZxG5gqpB3Vj/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/0rpmvYQMAGRg/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/l76mZVN8jman/file' // استبدل برابط التحميل الفعلي
    },
        {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '7.95 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/dkD3YaZ7e3LQ/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'The last of us 1 game.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('43.95 GB', ''));
            if (!isNaN(sizeValue)) {
