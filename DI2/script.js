...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/dZxG5geW63Vj/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/gXeGO1rBP3Aa/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '1.33 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/N2p3DZQVxGMa/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Dead Island 2 GAME.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('19.33 GB', ''));
            if (!isNaN(sizeValue)) {
