...
const partsData = [
    {
        ...
        url: 'https://akirabox.com/Z9dzBDWd5mk1/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/dkD3Yagnw3LQ/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/b5Ozd0MO9zB8/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/1RgzRBpD9zbp/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '5.7 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/5pVzNxBedm7w/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Grand Theft Auto 5 GAME.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('41.7 GB', ''));
            if (!isNaN(sizeValue)) {
