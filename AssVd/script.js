...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/QN9mEw8V7z6d/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/M2BGwYoZp3j4/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '7.76 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/k0embKZnV3Vb/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Assassins Creed Valhalla  DLC.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('25.76 GB', ''));
            if (!isNaN(sizeValue)) {
