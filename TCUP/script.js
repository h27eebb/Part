...
const partsData = [
    {
        ...
        url: 'https://akirabox.com/obj3jnDD23Dx/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/7d5GLE0wKmxR/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9.90 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/9QWmp7ZwrGEB/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '7.34 GB', // تم التعديل إلى GB
        url: 'https://akirabox.com/qLQ36pv7wG19/file' // استبدل برابط التحميل الفعلي
    },
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'The Crew 2 update.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('37.04 GB', ''));
            if (!isNaN(sizeValue)) {
