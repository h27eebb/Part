...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/9QWmp6AMNzEB/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/ex5z2Z5DBzKq/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/0Kezko7O2zD1/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/0PdzyBXPkGeA/file' // استبدل برابط التحميل الفعلي
    },
        {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '3.61 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/gXeGO1AQA3Aa/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        ...
        partsData.forEach(part => {
            ...
            const sizeValue = parseFloat(part.size.replace('39.61 GB', ''));
            if (!isNaN(sizeValue)) {
