...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/obj3jovqAzDx/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/qPez4dBbazOY/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/wgWGqO5o634o/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name:  'الجزء الرابع',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/EL73gx6PYz9B/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part5',
        name: 'الجزء الخامس',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/M2BGwYOyk3j4/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part6',
        name: 'الجزء السادس',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/Y2xm0wqE8GRO/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part7',
        name: 'الجزء السابع',
        size: '0.6 GB', // تم التعديل إلى GB
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'MW2+3 GAME.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('54.61 GB', ''));
            if (!isNaN(sizeValue)) {
