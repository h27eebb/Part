...
const partsData = [
    {
        ...
        url: 'https://akirabox.to/dkD3YaDKJ3LQ/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part2',
        name: 'الجزء الثاني',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/ZvqzlwpWa3aD/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part3',
        name: 'الجزء الثالث',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/gXeGO1eWd3Aa/file' // استبدل برابط التحميل الفعلي
    },
    {
        id: 'part4',
        name: 'الجزء الرابع',
        size: '9 GB', // تم التعديل إلى GB
        url: 'https://akirabox.to/N2p3DZd89GMa/file' // استبدل برابط التحميل الفعلي
    }
...
class PartsDownloader {
    ...
    displayFileInfo() {
        this.fullFileNameDisplay.textContent = 'Assassins Creed Valhalla  update.pkg'; // اسم ملف افتراضي
        
        let totalSizeGB = 0;
        partsData.forEach(part => {
            // التأكد من أن الحجم بصيغة 'X.XX GB' واستخراج القيمة الرقمية
            const sizeValue = parseFloat(part.size.replace('29.21 GB', ''));
            if (!isNaN(sizeValue)) {
